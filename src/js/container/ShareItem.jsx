...
class ShareItem extends Component {
  ...
  handleClick() {
    window.location.href = `http://m.163.com/newsapp/applinks.html?url=${encodeURIComponent(changeUrl('https://t.c.m.163.com/uncharted/index.html?getCard=1&cardId=', 2) + this.params.cardId + '&giftId=' + encodeURIComponent(this.giftId) + '&')}`
  }
  ...
  goCollect() {
    window.location.href = 'http://m.163.com/newsapp/applinks.html?url=' + changeUrl('https://t.c.m.163.com/uncharted/index.html', 2)
  }
